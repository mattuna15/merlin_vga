...
## Pmod header JB
set_property -dict {PACKAGE_PIN V9 IOSTANDARD LVCMOS33} [get_ports videoR0]
set_property -dict {PACKAGE_PIN V8 IOSTANDARD LVCMOS33} [get_ports videoR1]
set_property -dict {PACKAGE_PIN V7 IOSTANDARD LVCMOS33} [get_ports videoR2]
set_property -dict {PACKAGE_PIN W7 IOSTANDARD LVCMOS33} [get_ports videoR3]
set_property -dict {PACKAGE_PIN W9 IOSTANDARD LVCMOS33} [get_ports videoB0]
set_property -dict {PACKAGE_PIN Y9 IOSTANDARD LVCMOS33} [get_ports videoB1]
set_property -dict {PACKAGE_PIN Y8 IOSTANDARD LVCMOS33} [get_ports videoB2]
set_property -dict {PACKAGE_PIN Y7 IOSTANDARD LVCMOS33} [get_ports videoB3]


## Pmod header JC
set_property -dict {PACKAGE_PIN Y6 IOSTANDARD LVCMOS33} [get_ports videoG0]
set_property -dict {PACKAGE_PIN AA6 IOSTANDARD LVCMOS33} [get_ports videoG1]
set_property -dict {PACKAGE_PIN AA8 IOSTANDARD LVCMOS33} [get_ports videoG2]
set_property -dict {PACKAGE_PIN AB8 IOSTANDARD LVCMOS33} [get_ports videoG3]
set_property -dict {PACKAGE_PIN R6 IOSTANDARD LVCMOS33} [get_ports hSync]
set_property -dict {PACKAGE_PIN T6 IOSTANDARD LVCMOS33} [get_ports vSync]
...
## UART
set_property -dict {PACKAGE_PIN AA19 IOSTANDARD LVCMOS33} [get_ports txd1]
set_property -dict {PACKAGE_PIN V18 IOSTANDARD LVCMOS33} [get_ports rxd1]
